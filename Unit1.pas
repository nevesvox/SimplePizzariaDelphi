...
begin
  // Varifica se os campos do produto estão preenchidos
  ...
  begin
    ...
    begin
      // Caso não tenha escolhido exibe o alerta
    ...
    // Ativa o botão de exclusão de itens
...
begin
  ...
  Form4.bitConfirmar.Caption := 'Emitir Cupom Fiscal';
  //
...
// Funcao responsável por remover um item do array de Produtos
...
begin
  ...
  // Válida o array
  Assert(ALength > 0);
  Assert(Index < ALength, 'Atenção! Não foi encontrado o número do produto inserido, tente novamente!');
...
begin
  // Verifica se o atendente / garçom foi escolhidod
  if comBoxAtendente.ItemIndex = -1 then
  begin
    // Exibe a mensagem
    ShowMessage('Por favor, selecione um Atendente/Garçom!');
